...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_AcuferosSobreexplotados2023_1,
      colName: 'NOM_ACUI',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-13067268.745042, 2021654.578646, -10741010.704829, 3947741.343971], map.getSize());
	...
	for (i = 0; i < wms_layers.length; i++) {
		if (wms_layers[i][1] && wms_layers[i][0].getVisible()) {
			...
			if (url) {
				...
				container.appendChild(loadingIcon); // Cambia el ícono a la última imagen del "popup"
 ...
 * @type {string}
 */
var continueLineMsg = 'Click para continuar el dibujo de la linea';
 ...
 * @type {string}
 */
var continuePolygonMsg = "1click para continuar, 2click para terminar/cerrar";
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var conagua2webAttribution = document.createElement('li');
        conagua2webAttribution.innerHTML = '<a href="https://sigagis.conagua.gob.mx/gas1">CONAGUA|SGT|GAS|SIGA</a> &middot; ';
        var olAttribution = document.createElement('li');
        olAttribution.innerHTML = '<a href="https://openlayers.org/">OpenLayers</a> &middot; ';
        
        attributionList.insertBefore(conagua2webAttribution, firstLayerAttribution);
